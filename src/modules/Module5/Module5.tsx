...
const initialStudents: Student[] = [
    {id: 1, name: 'Aisha Dawud', grade: 'JSS 3'},
    {id: 2, name: 'Abubakar Auwal Usman', grade: 'JSS 2'}
]
...
export default function Module5(){
    ...
    return (
        <div className="module-header">
            ...
            <h1 className="module-title">Forms & User Input</h1>

            <p className="module-description">
                Controlled inputs capture user keypresses in React state, providind safe data entry,
                validations and dynamic list bindings.
            </p>
